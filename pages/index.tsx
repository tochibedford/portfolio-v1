...
export default function Home() {
  const skills = ["JAVASCRIPT", "TYPESCRIPT", "REACT", "THE CANVAS", ]
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main__container}>
        ...
        <div className={styles.work__with}>
          ...
          <motion.h2 className={styles.main__subheading__2} initial={{x: 100, opacity: 0}} animate={{x: 0, opacity: 1, transition: {duration: 0.7, delay: 0.3}}}>{"JAVASCRIPT"}</motion.h2>
        </div>
